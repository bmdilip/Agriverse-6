...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-agri-card/30 backdrop-blur-xl border-t border-agri-border">
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-agri-dark/50 to-transparent pointer-events-none" />
        ...
        <div className="py-16">
          ...
          >
            <div className="flex items-center justify-center space-x-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-r from-agri-primary to-agri-primary/80 rounded-2xl flex items-center justify-center shadow-lg shadow-agri-primary/25">
                <span className="text-agri-dark font-bold text-xl">A</span>
              </div>
              <div>
                <span className="text-3xl font-bold bg-gradient-to-r from-agri-primary to-agri-primary/80 bg-clip-text text-transparent">
                  Agriverse
                </span>
              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <motion.a
                    ...
                    className={`group w-12 h-12 bg-agri-card/50 backdrop-blur-sm border border-agri-border rounded-xl flex items-center justify-center text-agri-text/70 transition-all duration-300 hover:border-agri-primary/50 hover:bg-agri-primary/5 hover:shadow-lg hover:shadow-agri-primary/10 ${social.color}`}
                    whileHover={{ 
                      scale: 1.1,
                      y: -2
                    }}
